        ...
        <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12">
            <div className="col-span-full lg:col-span-2">
              ...
              <p className="text-gray-600 sm:pr-8">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-4">
                <div>
                  <a
                    href="#"
                    className="text-gray-600 border-b-2 border-transparent hover:border-green-500 hover:transition-all active:text-green-600 transition duration-100"
                  >
                    Overview
                  </a>
                </div>
          ...
          <div className="flex justify-between items-center gap-4 py-8">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                target="_blank"
                className="text-gray-400 hover:text-gray-600 active:text-gray-600 transition duration-100"
              >
                <svg
                  className="w-5 h-5"
                  width="24"
