    ...
    <div className="xl:w-5/12 h-100 lg:h-auto">
      <form className="max-w-lg mx-auto">
        <div className="flex flex-col gap-6 p-4 md:p-8 2xl:gap-10 2xl:py-16">
          ...
          <button className="btn block capitalize bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
            Book
          </button>
        </div>
      </form>
