        ...
        <div className="sm:text-center lg:text-left lg:py-12 xl:py-24">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
            <Link href="/#appointment" passHref>
              <a className="inline-block bg-green-500 hover:bg-green-600 active:bg-green-700 focus-visible:ring ring-green-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                Book Appointment
              </a>
            </Link>
